...
void CSceneMain::InitScene()
{
	...
	Draw::LoadImageW(L"Oxygen.png", 7, TEX_SIZE_512);
...
void CSceneMain::Scene()
{
	...
	{
	CObjmeteoL* obj;
	obj = new CObjmeteoL(200.0f, 0);
	Objs::InsertObj(obj, OBJ_meteoL, 2);
	obj->SetVector(0.0f, 1.0f);
	obj = new CObjmeteoL(290.0f, 0);
	Objs::InsertObj(obj, OBJ_meteoL, 2);
	obj->SetVector(0.0f, 1.0f);
	}
	else if (m_time == 950)
